...
: ${AMENT_CURRENT_PREFIX:="/opt/persistent_ws/install/dynamic_logistics_warehouse"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dynamic_logistics_warehouse/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dynamic_logistics_warehouse/environment/path.sh"
