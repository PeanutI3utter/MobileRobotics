...
: ${AMENT_CURRENT_PREFIX:="/opt/persistent_ws/install/hackathon_simulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hackathon_simulation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hackathon_simulation/environment/path.sh"
